...
<div class="container pb-6 pt-6">
    ...
    <form action="./php/guardar_usuario.php" method="POST" class="formAjax" autocomplete="off">
        <div class="columns">
            <div class="column">
                <div class="control">
        ...
        <div class="columns">
            <div class="column">
		    	<div class="control">
					<label>Usuario</label>
				  	<input class="input" type="text" name="usuario_usuario" pattern="[a-zA-Z0-9_]{4,20}" maxlength="20" required >
				</div>
		  	</div>
            <div class="column">
		    	<div class="control">
